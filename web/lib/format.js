...
import { tokenLogo } from './token.js';
...
export function copyButton(text, label = 'address') {
  ...
  // THE WHOLE ADDRESS IS IN THE LABEL. What the row shows is shortened, so a reader who
  // cannot see the button's neighbourhood — a screen reader, a keyboard user tabbing
  // through forty rows — is told exactly which address this copies, not "address".
