...
/*
 * hasDetail() used to live here and fetched /api/address itself. It moved to the caller,
 * which asks lib/data.js — the one module that knows a URL. This file is now only the
 * provider dance: discovery, and one permission request.
 */
