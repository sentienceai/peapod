...
Over the current seven-day window: **116,921 addresses traded, 29,897 of them closed a
round-trip.** 64.8% of those finished in profit, which sounds healthy until you see the
sizes: the best made $175,158, the median made **$0.57**, and the top 1% took 47% of
everything won.
...
- **70.1% of volume has no matched round-trip behind it.** Tokens that were bridged in,
...
- **RWA looks safer than Pons and is not.** 84.7% of qualifying RWA addresses are in
  profit against 46.4% on Pons, but the best RWA result is $4,796 against $175,158. The
