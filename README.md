...
Over the current seven-day window: **103,962 addresses traded, 26,365 of them closed a
round-trip.** 64.7% of those finished in profit, which sounds healthy until you see the
sizes: the best made $188,639, the median made **$0.68**, and the top 1% took 47% of
everything won.
...
- **70.9% of volume has no matched round-trip behind it.** Tokens that were bridged in,
...
- **RWA looks safer than Pons and is not.** 87.0% of qualifying RWA addresses are in
  profit against 47.8% on Pons, but the best RWA result is $2,477 against $188,639. The
